"""
Django settings for kowen project.
...
SECRET_KEY = 'django-insecure-a!x)_%*9-f1#_1i0n@ho7)g6hzw+%m&f2wf8h16@__v4*t$ea%'
...
WSGI_APPLICATION = 'kowen.wsgi.application'


# Database
# https://docs.djangoproject.com/en/4.1/ref/settings/#databases
# env not getting the variables from .env file
DATABASES = {
    'default': {
